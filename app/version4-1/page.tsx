...
import WorldJourney3D from "@/components/v4-1/WorldJourney3D";
...
/**
 * Version 4.1: everything version 13 says, flown in three.js. The world round
 * trip is the version 4 night flyover grown up — a scroll-driven camera over a
 * low-poly map — followed by the same timeline, destination and countdown.
 */
export default function Version41() {
  ...
  return (
    <div className="journey-night min-h-svh overflow-x-clip bg-(--jm-bg) font-sans text-(--jm-ink)">
      <Loader
      ...
      <JourneyFooter
        ...
        hashtag={config.hashtag}
        versions={otherVersions("/version4-1")}
      />
    </div>
  );
}
