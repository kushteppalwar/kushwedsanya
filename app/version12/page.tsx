...
import WorldJourney from "@/components/v11/WorldJourney";
import EventTimeline from "@/components/v12/EventTimeline";
...
export default function Version12() {
  ...
  return (
    <div className="journey-day min-h-svh bg-(--jm-bg) font-sans text-(--jm-ink)">
      ...
      <JourneyFooter
        ...
        versions={otherVersions("/version12")}
      />
    </div>
  );
}
