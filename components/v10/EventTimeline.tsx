...
export default function EventTimeline({ stops, title }: EventTimelineProps) {
              ...
              return (
                <li key={`${stop.group}-${stop.name}`} className="relative">
                  ...
                  <div className="relative md:grid md:grid-cols-[minmax(0,1fr)_4rem_minmax(0,1fr)] md:items-center">
                    ...
                    >
                      <CeremonyIcon name={stop.name} className="h-5 w-5" />
                    </span>
                    ...
                    >
                      <article className="rounded-2xl border border-(--jm-line) bg-(--jm-card) p-5 sm:p-6">
                        ...
                        <h3 className="mt-1.5 font-serif text-2xl leading-tight text-(--jm-ink) sm:text-3xl">
                          {stop.name}
                        </h3>
