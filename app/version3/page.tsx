...
import JourneyHero from "@/components/v3/JourneyHero";
...
export default function Version3() {
  ...
  return (
    <div className="journey-day min-h-svh bg-(--jm-bg) font-sans text-(--jm-ink)">
      <main>
        <JourneyHero config={config} calendarHref={calendarHref} calendarFileName={calendarFileName} />
      ...
      <JourneyFooter
        ...
        versions={otherVersions("/version3")}
      />
    </div>
  );
}
